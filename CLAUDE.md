...
- **Tests:** backend `pytest` — **940 passing** (measured 2026-09-17; 256 of
  ...
  `npm run build` passes and `vitest` is green (**142 cases** on 2026-09-17 —
...
- **Known gaps:** the Settings page has only the Appearance (theme) section
  ...
  still thin (component/lib tests only, 142 cases); the foreign markets are
...
---
*Last updated: 2026-09-17 (**Foreign markets — roadmap #22.** Krzysztof asked
