...
- **52-week context (added 2026-07-21):** every ranking row carries where the
  ...
  ticker but still analyse the same 120-day slice, so no rating changed.
...
- **Tests:** backend `pytest` — 290 passing; frontend `npm run build` passes.
