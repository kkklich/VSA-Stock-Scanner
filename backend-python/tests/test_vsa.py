...
class TestDetectSignals:
    ...
    def test_sos_detected_on_wide_up_bar_high_volume(self) -> None:
        ...
        bars.append(
            _bar("2026-01-27", open_=98.0, high=108.0, low=97.0, close=107.5, volume=120_000)
        )
    ...
    def test_spring_detected_when_price_dips_below_support_and_recovers(self) -> None:
        ...
        # Spring: dips to 98.5 (below 99 support), closes at 101 (above support).
        bars.append(
            _bar("2026-01-27", open_=100.0, high=101.5, low=98.5, close=101.2, volume=45_000)
        )
    ...
    def test_signals_are_chronological(self) -> None:
        bars = _normal_bars(n=25)
        bars.append(_bar("2026-01-27", open_=98.0, high=108.0, low=97.0, close=107.5, volume=120_000))
